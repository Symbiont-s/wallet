            ...
            <table>
                <thead>
                    <tr>
                        ...
                        >
                            {`${tt(
                                'outgoingdelegations_jsx.delegatee'
                            )} (${total})`}
                            <span
                                className={
                                    sortBy === DELEGATEE ? 'icon--active' : ''
                                }
                            >
                                {sort !== ASC ? (
                        ...
                        {isMyAccount && (
                            <th>
                                {tt('outgoingdelegations_jsx.revoke_title')}
                            </th>
                        )}
                    </tr>
                </thead>
                                ...
                                {isMyAccount && (
                                    <td>
                                        ...
                                        >
                                            {' '}
                                            {tt(
                                                'outgoingdelegations_jsx.revoke'
                                            )}{' '}
                                        </button>
                                    </td>
                                )}
